 ...
 */
export async function fetchToolDefinitions(serverConfig) {
    ...
    try {
        ...
        throw new Error(`Failed to fetch tools from ${serverConfig.name}: ${error instanceof Error ? error.message : String(error)}`);
    }
    finally {
        await client.close();
    }
